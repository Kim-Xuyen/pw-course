...
console.log("Trích xuất họ từ fullName (từ đầu đến ký tự thứ 6): ", lastName);

// 2. Trích xuất năm từ date (4 ký tự đầu). 
const year = date.substring(0, 4);
console.log("Trích xuất năm từ date (4 ký tự đầu):", year);

// 3. Trích xuất tên miền từ email (từ sau "@"). 
const domain = email.substring(email.indexOf("@") + 1);
console.log(`Trích xuất tên miền từ email (từ sau "@"): `, domain);